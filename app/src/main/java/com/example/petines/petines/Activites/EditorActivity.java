...
public class EditorActivity extends AppCompatActivity {
    ...
    private void postData(final String key) {
        ...
        Pets p = new Pets(name, species, breed, gender, birth, picture);

        Call<Pets> call = apiInterface.insertPet(p);
        ...
        call.enqueue(new Callback<Pets>() {
            ...
            public void onResponse(Call<Pets> call, Response<Pets> response) {
                ...
                if (name != ""){
                    ...
                    Toast.makeText(EditorActivity.this, name, Toast.LENGTH_SHORT).show();
                }
    ...
    private void updateData(final String key, final int id) {
        ...
        Pets p2 = new Pets(name, species, breed, gender, birth, picture);
        Call<Pets> call = apiInterface.updatePet(id, p2);
        ...
        call.enqueue(new Callback<Pets>() {
            ...
            public void onResponse(Call<Pets> call, Response<Pets> response) {
                ...
                if (name!= ""){
                    Toast.makeText(EditorActivity.this, name + " created", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void deleteData(final String key, final int id, final String pic) {
        ...
        Call<Pets> call = apiInterface.deletePet(id);
